        ...
        for target in targets:
            ...
            if original_msg.media:
                await woodcraft.send_file(
                    ...
                    caption=(original_msg.text or "").replace("@Latest_Movies_Reborn", "@moviedillu").replace("https://t.me/Latest_Movies_Reborn", "https://t.me/moviedillu"),
                    silent=True
                )
        ...
        try:
            ...
            if message.media:
                await woodcraft.send_file(
                    new_target_id,
                    file=message.media,
                    caption=(message.text or "").replace("@Latest_Movies_Reborn", "@moviedillu").replace("https://t.me/Latest_Movies_Reborn", "https://t.me/moviedillu"),
                    silent=True
                )
